...
# QQ emoji ID -> (name, display_hint)
QQ_EMOJI_MAP: dict[int, tuple[str, str]] = {
    0: ("惊讶", "😮"),
    1: ("撇嘴", "😒"),
    2: ("色", "😍"),
    3: ("发呆", "😳"),
    ...
    416: ("中龙舟", "🚣"),
    417: ("大龙舟", "🚣"),
    424: ("戳戳", "戳一戳 — QQ聊天常用戳一戳表情"),
    12951: ("㊗️", "祝的emoji,注意：QQ聊天中常被用作谐音'猪'，是熟人之间的玩笑话"),
}
...
def search_emoji(keyword: str) -> list[dict[str, Any]]:
    ...
    for emoji_id, (name, hint) in QQ_EMOJI_MAP.items():
        if kw in name.lower() or kw in hint.lower():
            results.append({"id": emoji_id, "name": name, "hint": hint})
    return results
